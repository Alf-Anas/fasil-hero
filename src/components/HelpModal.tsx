...
export const HelpModal: React.FC<HelpModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-xs p-3 sm:p-4 md:p-6">
      <div className="bg-slate-900 rounded-2xl sm:rounded-3xl max-w-xl w-full max-h-[90vh] flex flex-col shadow-2xl border border-slate-800 relative overflow-hidden">
        {/* Header - Pinned at top */}
        <div className="flex items-center justify-between border-b border-slate-800 p-4 sm:p-5 shrink-0 bg-slate-900 z-10">
          <div className="flex items-center gap-3 min-w-0">
            <div className="p-2.5 rounded-2xl bg-[#fbbc04]/10 text-[#fbbc04] border border-[#fbbc04]/20 shrink-0">
              <HelpCircle className="w-5 h-5 sm:w-6 sm:h-6" />
            </div>
            <div className="min-w-0">
              <h2 className="text-base sm:text-lg font-black text-white truncate">Bantuan & Informasi Program</h2>
          ...
          <button
            onClick={onClose}
            className="p-2 text-slate-400 hover:text-white rounded-full hover:bg-slate-800 transition-colors cursor-pointer shrink-0 ml-2"
            title="Tutup Modal"
          >
            <X className="w-5 h-5" />
          </button>
        ...
        <div className="p-4 sm:p-6 space-y-5 overflow-y-auto flex-1 min-h-0">
          ...
          <div className="p-4 bg-gradient-to-br from-amber-500/10 via-slate-950 to-slate-950 border border-amber-500/30 rounded-2xl space-y-3">
            <div className="flex items-center justify-between gap-2">
              ...
              <span className="px-2 py-0.5 rounded-md text-[10px] font-extrabold bg-[#fbbc04]/20 text-[#fbbc04] border border-[#fbbc04]/30 uppercase tracking-wider shrink-0">
                Link Referral
              </span>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 bg-slate-950 border border-slate-800 rounded-2xl space-y-2 hover:border-[#fbbc04]/40 transition-colors">
              <div className="flex items-center justify-between gap-2">
                ...
                <span className="px-2 py-0.5 rounded-md text-[10px] font-bold bg-amber-500/10 text-amber-400 border border-amber-500/20 shrink-0">
                  Google Arcade Team
                </span>
              </div>
              <p className="text-[11px] text-slate-400">
        ...
        <div className="flex justify-end p-4 sm:p-5 border-t border-slate-800 shrink-0 bg-slate-900 z-10">
          <button
            onClick={onClose}
            className="px-5 py-2 text-xs font-bold text-slate-950 bg-[#fbbc04] hover:bg-amber-400 rounded-xl transition-colors cursor-pointer"
          >
            Tutup
          </button>
        </div>
