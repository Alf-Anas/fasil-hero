...
export const OverviewTab: React.FC<OverviewTabProps> = ({
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      {/* Active Snapshot Summary Header */}
      <div className="bg-gradient-to-r from-blue-900/40 via-indigo-900/30 to-slate-900 p-5 sm:p-6 rounded-3xl border border-blue-500/20 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-300">
            Terdeteksi <strong className="text-white">{totalParticipants}</strong> peserta aktif dengan total <strong className="text-blue-400">{combinedPoints.toLocaleString()}</strong> poin gabungan.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2.5 w-full md:w-auto shrink-0">
          <button
            ...
            className="flex-1 md:flex-none inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-blue-600 text-white font-extrabold text-xs hover:bg-blue-500 shadow-md shadow-blue-500/20 transition-all cursor-pointer"
          >
      ...
      {/* Middle Section: Milestone Target & Quick Stats */}
            ...
            {nextTier ? (
              <div className="mt-4 space-y-2">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="font-extrabold text-blue-400">{progressPercentNext}%</span>
                </div>
                ...
                <div className="flex justify-between items-center text-[11px] text-slate-400 font-mono">
                  ...
                  <span className="text-amber-400 font-bold">Butuh {pointsNeededNext.toLocaleString()} Poin lagi</span>
                </div>
              </div>
            ) : (
            ...
            {topParticipants.map((p, idx) => {
              ...
              return (
                <div
                  ...
                  className="p-4 bg-slate-950 border border-slate-800 hover:border-blue-500/50 rounded-2xl transition-all cursor-pointer space-y-2 group"
                >
                  <div className="flex items-center justify-between">
                  ...
                  <div className="pt-2 border-t border-slate-800/80 flex items-center justify-between text-xs">
                    ...
                    <span className="font-extrabold text-amber-400">{totalP} Pts</span>
                  </div>
                </div>
              );
            })}
